...
LanguageProto _create() {
  ...
  const definition_11 = '(^|[^\\\\])#.+';
  const definition_12 =
      '("""|\'\'\')[\\s\\S]+?\\1|("|\')(?:\\\\.|(?!\\2)[^\\\\])*\\2|(?:^#?(?:(?:[0-9a-fA-F]){3}|[0-9a-fA-F]{6})\$)';
  const definition_3 = '\\b[a-z_]\\w*(?=\\()';
  const definition_4 =
  ...
  const definition_7 = '\\b(?:[Ff]alse|[Tt]rue)\\b';
  const definition_8 =
  ...
  definition_0.addAllTokens({
    ...
    'tag': [GrammarToken(pattern: RegExp(definition_5))],
