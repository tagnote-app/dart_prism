...
LanguageProto _create() {
  ...
  const definition_27 = '\\bCL_(?:FALSE|TRUE)\\b';
  const definition_29 =
  ...
  definition_21.addAllTokens({
    ...
    'char': [definition_36],
    'comment': [definition_37],
    'macro-name': [
      definition_46,
      definition_47,
    ],
    'directive': [definition_39],
    'directive-hash': [GrammarToken(pattern: RegExp(definition_40))],
    'punctuation': [GrammarToken(pattern: RegExp(definition_41))],
    'expression': [definition_42],
  });
