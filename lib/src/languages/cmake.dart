...
LanguageProto _create() {
  ...
  const definition_6 = '\\b(?:FALSE|OFF|ON|TRUE)\\b';
  const definition_7 =
  ...
  const definition_15 = '\\b\\w+::\\w+\\b';
  const definition_10 = '\\b\\d+(?:\\.\\d+)*\\b';
  const definition_11 = '\\b[a-z_]\\w*(?=\\s*\\()\\b';
  const definition_12 = '[()>}]|\\\$[<{]';
  ...
  definition_0.addAllTokens({
    ...
    'namespace': [GrammarToken(pattern: RegExp(definition_7))],
    'operator': [GrammarToken(pattern: RegExp(definition_8))],
    'inserted': [definition_9],
