...
LanguageProto _create() {
  ...
  const definition_21 =
      '(^[\\t ]*)#\\s*[a-z](?:[^\\r\\n\\\\/]|\\/(?!\\*)|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\\\(?:\\r\\n|[\\s\\S]))*';
  const definition_61 = '^(#\\s*include\\s*)<[^>]+>';
  const definition_24 = '"(?:\\\\(?:\\r\\n|[\\s\\S])|[^"\\\\\\r\\n])*"';
  const definition_62 = '(^#\\s*define\\s+)\\w+\\b(?!\\()';
  const definition_63 = '(^#\\s*define\\s+)\\w+\\b(?=\\()';
  const definition_56 = '^(#\\s*)[a-z]+';
  const definition_46 = '^#';
  const definition_47 = '##|\\\\(?=[\\r\\n])';
  const definition_57 = '\\S[\\s\\S]*';
  const definition_25 =
      '(\\b(?:enum|struct)\\s+(?:__attribute__\\s*\\(\\([\\s\\S]*?\\)\\)\\s*)?)\\w+|\\b[a-z]\\w*_t\\b';
  const definition_26 =
      '\\b(?:cl_(?:GLenum|GLint|GLuin|addressing_mode|bitfield|bool|buffer_create_type|build_status|channel_(?:order|type)|(?:u?(?:char|int|long|short)|double|float)(?:2|3|4|8|16)?|command_(?:queue(?:_info|_properties)?|type)|context(?:_info|_properties)?|device_(?:exec_capabilities|fp_config|id|info|local_mem_type|mem_cache_type|type)|(?:event|sampler)(?:_info)?|filter_mode|half|image_info|kernel(?:_info|_work_group_info)?|map_flags|mem(?:_flags|_info|_object_type)?|platform_(?:id|info)|profiling_info|program(?:_build_info|_info)?))\\b';
  const definition_28 = '\\bCL_(?:FALSE|TRUE)\\b';
  const definition_30 =
  ...
  const definition_16 = '[{}[\\];(),.:]';
  const definition_37 = '\\S+(?=:)';
  const definition_38 = '%\\w+';
  const definition_51 = '(^|[^@])\\b(?:0x[\\da-f]+|\\d+)';
  const definition_40 = '%[%?]|[|:;\\[\\]<>]';
  ...
  definition_50.rest = definition_60;
  ...
  definition_77.addAllTokens({
    ...
    'char': [definition_69],
    'comment': [definition_35],
    'macro-name': [
      definition_83,
      definition_84,
    ],
    'directive': [definition_80],
    'directive-hash': [GrammarToken(pattern: RegExp(definition_46))],
    'punctuation': [GrammarToken(pattern: RegExp(definition_47))],
    'expression': [definition_81],
  });
  definition_60.addAllTokens({
    'comment': [definition_35],
    'char': [definition_69],
    'macro': [definition_70],
    'string': [definition_36],
    'class-name': [definition_71],
  ...
  definition_50.addAllTokens({
    'delimiter': [definition_58],
    'bison-variable': [definition_59],
  });
  definition_18.addAllTokens({
    'c': [definition_34],
    'comment': [definition_35],
    'string': [definition_36],
    'property': [GrammarToken(pattern: RegExp(definition_37))],
    'keyword': [GrammarToken(pattern: RegExp(definition_38))],
    'number': [definition_39],
  ...
  definition_23.addAllTokens({
    ...
    'char': [definition_42],
    'comment': [definition_43],
    'macro-name': [
      definition_54,
      definition_55,
    ],
    'directive': [definition_45],
    'directive-hash': [GrammarToken(pattern: RegExp(definition_46))],
    'punctuation': [GrammarToken(pattern: RegExp(definition_47))],
